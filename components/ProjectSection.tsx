...
export default function ProjectsSection() {
  ...
  return (
    <section className="w-full px-20 py-20 bg-[#0D0D0D] text-white flex justify-center">
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 md:gap-[15rem] gap-10">
        ...
        <div className="flex flex-col justify-center space-y-4 pr-2 md:pr-4">
          <Reveal delay={0}>
            <div className="flex items-center text-base text-gray-400 gap-2">
              <span className="" style={{ color: accentCyan }}>
                <svg
